  ...
  return (
    <>
        <div className='prefooter'>
            <div>
                {repeatIcon}
                <p><b>Hasel-free replacement</b> <br /> 10 days retrun policy on mi.com</p>
            </div>
            <div>
                {shieldIcon}
                <p><b>100% secure payments</b> <br /> We suppors Cards, Wallets, EMI and COD</p>
            </div>
            <div>
                {mapIcon}
        ...
        <div className='midfooter'>
            ...
            <div>
                ...
                <span>Thanks! you are on our list for special notifications</span>
            </div>
            <div>
                <p>FOLLOW MI</p>
                <span>we want to here from you!</span>
            </div>
            <div>
        ...
        <div>Copyringt 🐱‍🏍 All Rights Researved</div>
        </div>
    </>
  )
}
